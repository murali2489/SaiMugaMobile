  ...
  return (
    <Icon
      ...
      onPress={() => {
        ...
        return DrawerProp.dispatch(DrawerActions.openDrawer());
      }}
    />
  );
};
    ...
    return (
      ...
      >
        <Svg viewBox="8 0 80 44" style={{ width: "20%" }}>
          ...
          <Path data-name="Image 1" fill="url(#prefix__a)" d="M0 0h93v44H0z" />
        </Svg>
        ...
        <MenuIcon DrawerProp={this.props.myNavigation} />
      </View>
    );
  }
}
